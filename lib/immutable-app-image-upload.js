...
async function processPrimaryImage () {
    ...
    if (defined(this.meta.cropData)) {
        ...
        var left = this.meta.cropData.x || 0
        // get number of pixels to crop from top
        var top = this.meta.cropData.y || 0
        // get the height of cropped image
        var height = this.meta.cropData.height || this.sharpMetaData.height - top
        // get the width of cropped image
        var width = this.meta.cropData.width || this.sharpMetaData.width - left
