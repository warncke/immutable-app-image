...
function getPictureData (args) {
    ...
    var imageType = this.imageTypesById[imageTypeId]
    // picture data
    ...
    if (profile.hasWebp) {
        picture.source = [
            {
                fileType: 'webp',
                srcset: this.getSrc(imageData.path, imageData.fileName, 'webp', imageId, profile.imageProfileName),
                type: 'image/webp',
            },
            {
                fileType: profile.fileType,
                srcset: this.getSrc(imageData.path, imageData.fileName, profile.fileType, imageId, profile.imageProfileName),
